...
class ViewPage extends Component {
  ...
  componentDidMount() {
    ...
    const response = axios.get(`https://${id}.ngrok.io/userview?client_id=${searchuser_view}`, {
      mode: "cors",
      headers: {
        'Authorization': token,
  ...
  render() {
    ...
    if (this.state.user_view) {
      return (<Redirect to={'/viewhierarchy'}/>)
    }
        ...
        <div className="Hobby" style={{
          ...
          <div>
            <p className="parahobby" style={{
              ...
              <br/><br/>
              <button onClick={this.user_view_fun.bind(this)} class="btn btn-warnning" style={{
                  marginLeft: "75%",
                  border: "outset",
